...
import { getAuth, signInWithEmailAndPassword, signOut, onAuthStateChanged,
         createUserWithEmailAndPassword, updateProfile, updatePassword, EmailAuthProvider, reauthenticateWithCredential, sendPasswordResetEmail }
...
window.sendPasswordReset = async () => {
  ...
  errEl.classList.remove("show");
  if (!email) {
    errEl.textContent = "Por favor ingresa tu correo.";
    errEl.classList.add("show");
    return;
  }
  try {
    await sendPasswordResetEmail(auth, email);
    showToast("✅ Correo de recuperación enviado. Revisa tu bandeja.", "success", 7000);
    hideForgotPassword();
  } catch (e) {
